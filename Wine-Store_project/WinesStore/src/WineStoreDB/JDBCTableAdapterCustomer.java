 ...
 * @author bryan
 */
public class JDBCTableAdapterCustomer extends DefaultTableModel {

    private String tableName;
    private String sqlColumnNames[];
    private int sqlColumnTypes[];

    public JDBCTableAdapterCustomer(ResultSet res, String name) {
        super();
        ...
        try {
            ...
            Logger.getLogger(JDBCTableAdpaterWines.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.setDataVector(data, columnNames);

    }

    public JDBCTableAdapterCustomer(ResultSet res) {
