...
public class JDBCTableCustomer extends DefaultTableModel {

    private String tableName;
    private String sqlColumnNames[];
    private int sqlColumnTypes[];

    public JDBCTableCustomer(ResultSet res, String name) {
        super();
        ...
        try {
            ...
            Logger.getLogger(JDBCTableCustomer.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.setDataVector(data, columnNames);

    }

    public JDBCTableCustomer(ResultSet res) {
    ...
    public boolean isCellEditable(int row, int column) {
        if (column == 0 || column == 4 || column == 3 || column == 5 || column == 6) {
            return false;
        } else {
            return true;
        }
