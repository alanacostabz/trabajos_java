 ...
 * @author rnavarro
 */
public class DeleteRefGrapeVarieties extends javax.swing.JDialog {
    ...
    public DeleteRefGrapeVarieties(java.awt.Frame parent, Database db) {
        super(parent, true);
        this.db = db;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Borrar tipo de uva:");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        String combo = comboName.getSelectedItem().toString();
         ...
         if (combo.equals("Seleccionar")) {
            JOptionPane.showMessageDialog(rootPane, "Seleccione un tipo de uva.");
        } else {
        // String item = (String) comboName.getSelectedItem();
       
       // String id = item.substring(0, item.indexOf(' '));
       String c = comboName.getSelectedItem().toString();
       int input = JOptionPane.showConfirmDialog(rootPane, "¿Está seguro de borrar el tipo de uva " + combo + " con ID = " + id + "?","Borrar tipo de uva", 0);
            if (input == 0) {
               
        String sql = String.format("delete from winestore.ref_grape_varieties where grape_variety_code = %s", id.intValue());
        ...
        JOptionPane.showMessageDialog(rootPane,"El tipo "+combo+" de uva ha sido eliminado exitosamente.");
        
        
        final String sql1 = String.format("SELECT grape_variety_Code,Grape_variety_name FROM winestore.ref_grape_varieties order by grape_variety_name");
    ...
    private void comboNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboNameActionPerformed
        ...
        String id1 = "";
        aghh.setText("");
        final String sql1 = String.format("SELECT grape_variety_code nombre FROM winestore.ref_grape_varieties where grape_variety_code = " + s);
        try {
