 ...
 * @author rnavarro
 */
public class JDBCTableAdpaterRegion extends DefaultTableModel {
    
    private String tableName;
    private String sqlColumnNames[];
    private int sqlColumnTypes[];
    
    public JDBCTableAdpaterRegion(ResultSet res, String name) {
        super();
        ...
        try {
            ...
            Logger.getLogger(JDBCTableAdpaterRegion.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.setDataVector(data, columnNames);
      
    }

    public JDBCTableAdpaterRegion(ResultSet res) {
