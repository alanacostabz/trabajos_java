 ...
 * @author rnavarro
 */
public class JDBCTableAdpaterWines extends DefaultTableModel {

    private String tableName;
    private String sqlColumnNames[];
    private int sqlColumnTypes[];

    public JDBCTableAdpaterWines(ResultSet res, String name) {
        super();
    ...
    public JDBCTableAdpaterWines(ResultSet res) {
