 ...
 * @author Maestro
 */
public class InsertRefCountries extends javax.swing.JDialog {
    ...
    public InsertRefCountries(java.awt.Frame parent, Database db) {
        super(parent, true);
        initComponents();
        this.db = db;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Agregar nuevo País");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (text.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Campo vacío, favor de ingresar el nombre de un país.");
        } else {
            try {
                if (validacionDatos(text) > 0) {
                    JOptionPane.showMessageDialog(this, "El país " +text+ " ya se encuentra en la base de datos.");
                } else {
                    int input = JOptionPane.showConfirmDialog(rootPane, "¿Está seguro de agregar el país " + text.toUpperCase() + "?", "Agregar país", 0);
                    if (input == 0) {
                    StringBuilder sql
                ...
                Logger.getLogger(InsertRefCountries.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
