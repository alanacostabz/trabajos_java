...
public class JDBCTableAdapterPurchases extends DefaultTableModel {
    
    private String tableName;
    private String sqlColumnNames[];
    private int sqlColumnTypes[];
    
    public JDBCTableAdapterPurchases(ResultSet res, String name) {
        super();
        ...
        try {
            ...
            Logger.getLogger(JDBCTableAdapterPurchases.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.setDataVector(data, columnNames);

    }

    public JDBCTableAdapterPurchases(ResultSet res) {
